...
class LogViewerWidget(QWidget):
    ...
    def _show_subsystems_dialog(self, lpar_name, subsystems):
        ...
        dialog.setStyleSheet("QDialog { background-color: #161b22; color: #c9d1d9; }")
